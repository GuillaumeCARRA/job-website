...
module.exports = {
    ...
    createJobSeeker: async(request, response) => {
        ...
        const jobSeekerData = {
            ...
            driving_licence:  request.params.driving_licence,
            phone_number: request.params.phone_number,
            current_job_title:  request.params.current_job_title,
            is_current_job:  request.params.is_current_job,
            availability_job:  request.params.availability_job,
            skill_level:  request.params.skill_level,
            degree_level:  request.params.degree_level,
            degree_name:  request.params.degree_name,
            annual_salary:  request.params.annual_salary,
            worker_status:  request.params.worker_status,
            job_title_search:  request.params.job_title_search,
            job_location_search:  request.params.job_location_search,
            job_contract_search: request.params.job_contract_search,
        }
